...
steps = [
    ...
    ("📈 Step 3: Get GG Metarating", ["node", "club.3.gg.meta.js"]),
    ("🧹 Step 4: Clean player data", ["python", "club.4.clean.gg.py"]),
    ("🔍 Step 5: Enrich with meta ratings", ["node", "club.5.get.meta.js"]),
]
