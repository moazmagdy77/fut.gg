...
DATA_FILE = BASE_DATA_DIR / 'training_dataset_gg_boost_delta.csv'
...
def main():
    print("🚀 Starting ggMeta BOOST DELTA model training script...")
    ...
    for role_col in role_cols:
        ...
        train_and_save_model(df_subset, 'target_ggMetaBoostDelta', role_name, 'ggMetaBoostDelta')
        
    print("\n🎉 All ggMeta boost delta models trained successfully.")
